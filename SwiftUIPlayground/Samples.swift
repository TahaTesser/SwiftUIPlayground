...
public enum SampleCatalog {
    public static let sections: [SampleSection] = [
        ...
        SampleSection(title: "Drawing and Graphics", samples: [
        ...
        SampleSection(title: "Tables", samples: [
            // https://developer.apple.com/documentation/swiftui/table
            SampleItem("Table") { TableSample() },
        ]),
        SampleSection(title: "Text", samples: [
        ...
        SampleSection(title: "Navigation", samples: [
        ...
        SampleSection(title: "Images", samples: [
        ...
        SampleSection(title: "View Groupings", samples: [
        ...
        SampleSection(title: "Lists", samples: [
